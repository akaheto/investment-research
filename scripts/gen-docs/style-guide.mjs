...
await writeDoc("VISUAL_STYLE_GUIDE.docx", [
  ...
  table(["Component", "Pattern"], [
    ...
    ["Nav", "Left rail 220px (collapsible to icons): Dashboard, Watchlist, Screener, Markets, News, Oracle, Portfolio, Settings, Admin. Active item = accent text + accent left bar."],
